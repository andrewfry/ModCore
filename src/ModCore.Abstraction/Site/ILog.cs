...
namespace ModCore.Abstraction.Site
{
    public interface ILog
    {
        ...
        void LogError(string className, SessionData sessionData, Exception exception, string message, params string[] messageVariables);
        ...
        void LogWarning(string className, SessionData sessionData, Exception exception, string message, params string[] messageVariables);
        ...
        void LogDebug(string className, SessionData sessionData, string message, params string[] messageVariables);
        ...
        void LogInfo(string className, SessionData sessionData, string message, params string[] messageVariables);
